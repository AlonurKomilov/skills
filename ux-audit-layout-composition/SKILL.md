---
name: ux-audit-layout-composition
version: 1.0.3
family: abc
domain: ux
kind: audit
...
> |---|---|
> | "this gap/radius/size isn't on the scale" · "this control isn't the shared primitive" (e.g. a native checkbox amid styled ones) | `ux-audit-design-system` (discovers and audits against the project's own design docs/tokens) |
...
> Tie-breaker: an off-ladder size anywhere → `ux-audit-design-system`,
...
- <finding that surfaced here but belongs to `ux-audit-design-system`
