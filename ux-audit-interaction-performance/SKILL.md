---
name: ux-audit-interaction-performance
version: 1.5.3
family: abc
domain: ux
kind: audit
method: interaction-performance
...
> arrangement/geometry → `ux-audit-layout-composition`; token/value
> compliance → `ux-audit-design-system`; HOW to obtain a needed component
...
question to `ux-audit-psychology` / `ux-audit-layout-composition` — do
